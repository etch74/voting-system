...
export default function SetupPage() {
  return (
    <div style={{ minHeight:"100vh", background:T.pageBg, display:"flex", alignItems:"center", justifyContent:"center", padding:20, position:"relative" }}>
      <Stars/>
      <div style={{ position:"relative", zIndex:1, width:"min(500px,100%)", textAlign:"center" }}>
        <img src={logo} alt="Among Us IRL" style={{ width:100, height:"auto", marginBottom:12 }} />
        ...
        <div style={{ color:T.muted, fontSize:"0.78rem", lineHeight:1.9, marginBottom:24 }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
            {steps.map(([n,text])=>(
              <div key={n} style={{ display:"flex", gap:12, alignItems:"flex-start" }}>
                ...
                <div style={{ color:T.muted, fontSize:"0.78rem", lineHeight:1.7 }}>{text}</div>
              </div>
            ))}
          </div>
        </Card>
